			...
			if (_objHelper.checkDBResponse(_dtresp))
			{
				...
				else
				{
					List<Claim> claims = new List<Claim>
					{
						...
						new Claim("FullName", Convert.ToString(_dtresp.Rows[0]["FullName"]), null),
						new Claim("Gender",  Convert.ToString(_dtresp.Rows[0]["Gender"]), null),
						new Claim("User_Type",  Convert.ToString(_dtresp.Rows[0]["User_Type"]), null),
						new Claim("Profile_Pic",  Convert.ToString(_dtresp.Rows[0]["Profile_Pic"]), null),
						new Claim("User_Group_ID",  Convert.ToString(_dtresp.Rows[0]["User_Group_ID"]), null),
						new Claim("User_Group_Name",  Convert.ToString(_dtresp.Rows[0]["User_Group_Name"]), null),
